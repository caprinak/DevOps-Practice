...
public class OrderService {
        ...
        @Transactional
        @io.github.resilience4j.circuitbreaker.annotation.CircuitBreaker(name = "payment", fallbackMethod = "fallbackMethod")
        ...
        public Integer fallbackMethod(OrderRequest request, Throwable t) {
                throw new BusinessException("Oops! Something went wrong, please try again later!");
        }
